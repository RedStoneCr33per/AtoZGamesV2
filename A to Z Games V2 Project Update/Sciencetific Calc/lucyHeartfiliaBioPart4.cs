...
{
    public partial class lucyHeartfiliaBioPart4 : Form
    {
        public lucyHeartfiliaBioPart4()
        {
            InitializeComponent();
        }

        private void lucyBackBtn4_Click(object sender, EventArgs e)
        {
            this.Hide();
            lucyHeartfiliaBioPart3 popup = new lucyHeartfiliaBioPart3();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void lucyNextBtn4_Click(object sender, EventArgs e)
        {
            this.Hide();
            lucyHeartfiliaBioPart5 popup = new lucyHeartfiliaBioPart5();
            DialogResult dialogresult = popup.ShowDialog();
        }
