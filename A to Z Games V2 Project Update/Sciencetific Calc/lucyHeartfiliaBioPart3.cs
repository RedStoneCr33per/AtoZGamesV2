...
{
    public partial class lucyHeartfiliaBioPart3 : Form
    {
        public lucyHeartfiliaBioPart3()
        {
            InitializeComponent();
        }

        private void lucyBackBtn3_Click(object sender, EventArgs e)
        {
            this.Hide();
            lucyHeartfiliaBioPart2 popup = new lucyHeartfiliaBioPart2();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void lucyNextBtn3_Click(object sender, EventArgs e)
        {
            this.Hide();
            lucyHeartfiliaBioPart4 popup = new lucyHeartfiliaBioPart4();
            DialogResult dialogresult = popup.ShowDialog();
        }
        ...
        private void slotMachineToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
