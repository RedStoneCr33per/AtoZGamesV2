...
namespace Sciencetific_Calc
{
    public partial class fairyTailMenu : Form
    {
        ...
        private void fairyTailEpisodes_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void fairyTailEndings_Click(object sender, EventArgs e)
        {
            this.Hide();
            fairyTailEndings popup = new fairyTailEndings();
            DialogResult dialogresult = popup.ShowDialog();
        }
    }
}
