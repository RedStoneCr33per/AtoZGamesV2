...
{
    public partial class natsuDragneelBioPart5 : Form
    {
        public natsuDragneelBioPart5()
        {
            InitializeComponent();
        }

        private void natsuNextBtn5_Click(object sender, EventArgs e)
        {
            this.Hide();
            natsuDragneelBioPart6 popup = new natsuDragneelBioPart6();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void natsuBackBtn5_Click(object sender, EventArgs e)
        {
            this.Hide();
            natsuDragneelBioPart4 popup = new natsuDragneelBioPart4();
            DialogResult dialogresult = popup.ShowDialog();
        }
