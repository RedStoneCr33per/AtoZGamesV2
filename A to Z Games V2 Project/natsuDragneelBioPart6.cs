...
{
    public partial class natsuDragneelBioPart6 : Form
    {
        public natsuDragneelBioPart6()
        {
            InitializeComponent();
        }

        private void natsuNextBtn6_Click(object sender, EventArgs e)
        {
            this.Hide();
            natsuDragneelBioPart7 popup = new natsuDragneelBioPart7();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void natsuBackBtn6_Click(object sender, EventArgs e)
        {
            this.Hide();
            natsuDragneelBioPart5 popup = new natsuDragneelBioPart5();
            DialogResult dialogresult = popup.ShowDialog();
        }
