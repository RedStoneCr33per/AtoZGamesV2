...
{
    public partial class natsuDragneelBioPart7 : Form
    {
        public natsuDragneelBioPart7()
        {
            InitializeComponent();
        }

        private void natsuNextBtn7_Click(object sender, EventArgs e)
        {
            this.Hide();
            natsuDragneelBioPart8 popup = new natsuDragneelBioPart8();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void natsuBackBtn7_Click(object sender, EventArgs e)
        {
            this.Hide();
