...
{
    public partial class natsuDragneelBioPart2 : Form
    {
        public natsuDragneelBioPart2()
        {
            InitializeComponent();
        }
        ...
        private void natsuNextBtn2_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void natsuBackBtn2_Click(object sender, EventArgs e)
        {
            this.Hide();
