...
namespace Sciencetific_Calc
{
    public partial class paint : Form
    {
        ...
        private void paintBucketPicBtn_Click(object sender, EventArgs e)
        {
            ColorDialog pb = new ColorDialog();
        ...
        private void eraserPicBtn_Click(object sender, EventArgs e)
        {
            p.Color = white.BackColor;
        }
    }
