...
{
    public partial class saoOpenings : Form
    {
        public saoOpenings()
        {
            InitializeComponent();
        ...
        private void saoNextOpeningBtn1_Click(object sender, EventArgs e)
        {
            this.Hide();
            saoOpening5 popup = new saoOpening5();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void saoOpeningBackBtn1_Click(object sender, EventArgs e)
        {
            this.Hide();
