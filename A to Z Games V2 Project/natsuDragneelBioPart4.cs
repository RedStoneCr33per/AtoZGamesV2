...
{
    public partial class natsuDragneelBioPart4 : Form
    {
        public natsuDragneelBioPart4()
        {
            InitializeComponent();
        }

        private void natsuNextBtn4_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void natsuBackBtn4_Click(object sender, EventArgs e)
        {
            this.Hide();
