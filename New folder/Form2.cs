    ...
    public partial class Form2 : Form
    {
        ...
        private void Operator_Click(object sender, EventArgs e)
        {
            ...
            if( value != 0)
            {
                ...
                if (b.Text == "Sq")
                    result.Text = Operators.sq(Double.Parse(result.Text)).ToString();
                if (b.Text == "%")
                    result.Text = Operators.percent(Double.Parse(result.Text)).ToString();
                if (b.Text == "x^3")
                    result.Text = Operators.x3(Double.Parse(result.Text)).ToString();
                equal.PerformClick();
        ...
        private void regularCalcToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
