...
{
    public partial class lucyHeartfiliaBioPart5 : Form
    {
        public lucyHeartfiliaBioPart5()
        {
            InitializeComponent();
        }

        private void lucyBackBtn5_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void lucyNextBtn5_Click(object sender, EventArgs e)
        {
            this.Hide();
            lucyHeartfiliaBioPart6 popup = new lucyHeartfiliaBioPart6();
            DialogResult dialogresult = popup.ShowDialog();
        }
