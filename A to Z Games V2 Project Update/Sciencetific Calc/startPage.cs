...
namespace Sciencetific_Calc
{
    public partial class startPage : Form
    {
        ...
        private void flappyBirdToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            this.Hide();
            Flappy_Bird popup = new Flappy_Bird();
            DialogResult dialogresult = popup.ShowDialog();
        ...
        {
            this.Hide();
            alarmClock popup = new alarmClock();
            DialogResult dialogresult = popup.ShowDialog();
        }
        ...
        {
            this.Hide();
            calender popup = new calender();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void brainGameToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Hide();
            brainGame popup = new brainGame();
            DialogResult dialogresult = popup.ShowDialog();
        }
        ...
        {
            this.Hide();
            pokemonMap popup = new pokemonMap();
            DialogResult dialogresult = popup.ShowDialog();
        }
        ...
        {
            this.Hide();
            chessBoard popup = new chessBoard();
            DialogResult dialogresult = popup.ShowDialog();
        }
    }
}
