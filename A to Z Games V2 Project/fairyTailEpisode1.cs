...
{
    public partial class fairyTailEpisode1 : Form
    {
        public fairyTailEpisode1()
        {
            InitializeComponent();
        }
        ...
        private void fairyTailEpisodeNextBtn1_Click(object sender, EventArgs e)
        {
            this.Hide();
            webBrowser popup = new webBrowser();
            DialogResult dialogresult = popup.ShowDialog();
        ...
        private void fairyTailEpisodeBtn1_Click(object sender, EventArgs e)
        {
            this.Hide();
