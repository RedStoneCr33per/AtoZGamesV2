...
{
    public partial class lucyHeartfiliaBioPart2 : Form
    {
        public lucyHeartfiliaBioPart2()
        {
            InitializeComponent();
        }

        private void lucyBackBtn2_Click(object sender, EventArgs e)
        {
            this.Hide();
            lucyHeartfiliaBioPart1 popup = new lucyHeartfiliaBioPart1();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void lucyNextBtn2_Click(object sender, EventArgs e)
        {
            this.Hide();
