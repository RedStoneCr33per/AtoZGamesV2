...
{
    public partial class natsuDragneelBio : Form
    {
        public natsuDragneelBio()
        {
            InitializeComponent();
        }
        ...
        private void natsuNextBtn1_Click(object sender, EventArgs e)
        {
            this.Hide();
            natsuDragneelBioPart2 popup = new natsuDragneelBioPart2();
            DialogResult dialogresult = popup.ShowDialog();
        }

        private void natsuBackBtn1_Click(object sender, EventArgs e)
        {
            this.Hide();
