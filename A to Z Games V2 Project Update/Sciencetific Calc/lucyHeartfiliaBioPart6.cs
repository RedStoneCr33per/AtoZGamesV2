...
{
    public partial class lucyHeartfiliaBioPart6 : Form
    {
        public lucyHeartfiliaBioPart6()
        {
            InitializeComponent();
        }

        private void lucyBackBtn6_Click(object sender, EventArgs e)
        {
            this.Hide();
        ...
        private void lucyNextBtn6_Click(object sender, EventArgs e)
        {
            this.Hide();
            lucyHeartfiliaBioPart7 popup = new lucyHeartfiliaBioPart7();
            DialogResult dialogresult = popup.ShowDialog();
        }
